  ...
  <div class="dashboard-cards">
    <div class="row row-cards">
        <div class="col-md-4 no-padding">
            <div class="card menu-card">
                <div class="card-image">
                    <img src="https://restbank-vue.s3-eu-west-1.amazonaws.com/static/img/portfolio.jpg" class="img responsive" alt="portfolio">
                </div>
        ...
        <div class="col-md-4 no-padding">
            <div class="card menu-card">
                <div class="card-image">
                    <img src="https://restbank-vue.s3-eu-west-1.amazonaws.com/static/img/advert.jpg" class="img responsive" alt="thompson campaign">
                </div>
                <div class="card-content">
        ...
        <div class="col-md-4 no-padding">
            <div class="card menu-card">
                <div class="card-image">
                    <img src="https://restbank-vue.s3-eu-west-1.amazonaws.com/static/img/blockchain.jpg" class="img responsive" alt="blockchain">
                </div>
                <div class="card-content">
