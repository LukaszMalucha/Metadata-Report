          ...
          <div class="col-md-5 col-lg-4 plain-element">
            <table class="table table-transaction">
              ...
              <tr  v-for="asset in assets" :key="asset.id">
                <td v-if="asset.name == 'USD'" class="cash-cell">Cash on Hand:</td>
                <td v-if="asset.name == 'USD'" class="">
          ...
          <div class="col-xs-5 col-sm-5 col-md-5 col-lg-4 plain-element">
            <table class="table table-transaction">
              <tbody>
                ...
                <tr  v-for="asset in assets" :key="asset.id" class="transparent">
                    <td v-if="asset.name == 'USD'" class="cash-cell">Cash on Hand:</td>
                    <td v-if="asset.name == 'USD'" class="">
        ...
        <div class="row plain element">
          <table id="instrumentTable">
            ...
            <tr v-for="asset in filteredList" :key="asset.pk">
              <td v-if="asset.name != 'USD'">{{ asset.name }}</td>
              <td v-if="asset.name != 'USD'" class="text-center">{{ asset.symbol }}</td>
              <td v-if="asset.name != 'USD'" class="text-center">{{ asset.category }}</td>
              <td v-if="asset.name != 'USD'" class="text-center">{{ asset.quantity }}</td>
              <td v-if="asset.name != 'USD'" class="text-center">{{ formatPrice(asset.price) }}</td>
              <td v-if="asset.name != 'USD'" class="text-center">{{ formatPrice(asset.value) }}</td>
              <td v-if="asset.name != 'USD'" class="text-center">
...
//          Get the total value of a portfolio
        ...
        window.console.log("User has to login first.")
      }
    },
    fillData () {
